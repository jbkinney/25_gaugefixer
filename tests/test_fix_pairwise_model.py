...
class TestFixPairwiseModel:
    """Test class for testing fix_pairwise_model functionality."""
    
    def setup_method(self):
        """Setup test parameters."""
        self.L = 8  # Smaller L for faster tests
        self.alphabet = get_alphabet('dna')
        self.alpha = len(self.alphabet)
        self.features = get_pairwise_features(L=self.L, alphabet=self.alphabet)
    ...
    def test_fix_pairwise_model_zero_sum(self):
        """Test fix_pairwise_model with zero-sum gauge."""
        # Fix gauge with zero-sum
        fixed_theta_series = fix_pairwise_model(
    ...
    def test_fix_pairwise_model_wild_type(self):
        """Test fix_pairwise_model with wild-type gauge."""
    ...
    def test_fix_pairwise_model_custom_pi_lc(self):
        """Test fix_pairwise_model with custom pi_lc."""
    ...
    def test_fix_pairwise_model_numpy_input(self):
        """Test fix_pairwise_model with numpy array input and features."""
    ...
    def test_fix_pairwise_model_numpy_input_no_features(self):
        """Test fix_pairwise_model with numpy array input and no features."""
        # Convert Series to numpy array
        theta_array = self.theta_series.values
        sorted_features = get_pairwise_features(L=self.L, alphabet=self.alphabet)
    ...
    def test_fix_pairwise_model_feature_order_preservation(self):
        ...
        fixed_shuffled_theta = fix_pairwise_model(
    ...
    def test_theta_and_features_mismatch(self):
        ...
        # Different set of features than expected for pairwise model
        # Create a subset of the features to simulate a mismatch
        subset_features = self.features[:-1]  # Remove one feature
        with pytest.raises(AssertionError):
            fix_pairwise_model(
                theta=self.theta_series,
                L=self.L, 
