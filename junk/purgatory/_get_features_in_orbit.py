...
def _get_features_in_orbit(
    ...
    This function creates all features that have combinations of characters
    ...
    Returns:
        List[str]: List of all features in the orbit
    
    Examples:
        >>> _get_features_in_orbit(['A', 'B', 'C'], [0, 2], 3)
    ...
    features = [''.join(chars) for chars in product(*char_options)]
