...
if __name__ == "__main__":
    ...
    times = pd.read_csv("results/benchmarking.csv", index_col=0)
    ...
    print("Saving plots")
    fig.savefig("results/fig2_benchmarks_raw.png", dpi=300, facecolor="white", edgecolor="none")
    fig.savefig("results/fig2_benchmarks_raw.pdf", facecolor="white", edgecolor="none")
    fig.savefig("results/fig2_benchmarks_raw.svg", facecolor="white", edgecolor="none")
    print("Done")
